...
if __name__ == "__main__":
    ...
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.063, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.088, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.125, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.177, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.25, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.354, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.5, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=0.707, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=1, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=1.414, mu=0.5)
    # train_cifar10(mixup="weighted", name="mu05", gamma=2, mu=0.5)
    pass
