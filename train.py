...
if __name__ == "__main__":
    ...
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.063)
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.088)
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.125)
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.177)
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.25)
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.354)
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.5)
    # train_cifar10(mixup="weighted", name="mu05", mu=0.5, gamma=0.707)
